...
qa_rows = [
    ["QA-RB-001", "客户分层", "金穗级", "金穗级客户需要达到什么条件？", "金穗级门槛；客户升级条件", "个人客户", "客户最近连续3个月月日均综合金融资产达到50万元，且客户身份资料完整、风险评级有效。该标准为华辰银行Mock演示口径，不代表任何真实银行。", "连续3个月达标；KYC有效", "客户有效身份证件、联系方式", "客户经理工作台自动识别，次月5日前更新", "不得承诺永久保级；异常资产需核实来源", "客户质疑资产计算或系统未更新", "SOP-RB-001", "MOCK", "V1.0"],
    ["QA-RB-002", "客户分层", "白金级", "白金级客户的资产门槛是多少？", "白金客户标准；高净值客户门槛", "个人客户", "最近连续3个月月日均综合金融资产达到200万元可进入白金级候选名单，经系统校验后生效。本条为Mock内部口径。", "连续3个月达标", "无需额外申请材料", "系统批量认定", "不得用临时转入资金诱导冲量", "名单异常或客户提出异议", "SOP-RB-001", "MOCK", "V1.0"],
    ["QA-RB-003", "客户分层", "降级保护", "客户资产短期下降会马上降级吗？", "保级期多久；资产下降怎么办", "个人客户", "不会立即降级。华辰银行Mock规则设置60天观察期；观察期结束仍未恢复标准的，次月调整等级。涉嫌异常交易或账户风险管控的除外。", "非风险事件导致的自然波动", "无", "系统观察名单", "风险管控不适用保级承诺", "客户要求人工保级", "SOP-RB-001", "MOCK", "V1.0"],
    ["QA-AC-001", "账户服务", "借记卡开户", "客户新开借记卡需要带什么？", "办银行卡材料；开户证件", "年满18周岁的境内个人", "客户本人携带有效居民身份证原件，提供本人实名手机号，并配合完成开户用途、职业、常住地址和受益所有人等身份核实。特殊情形按柜面要求补充辅助证明。", "本人办理；身份可核验", "身份证原件、实名手机号；必要时辅助证明", "网点柜面", "不得以营销需要简化客户身份识别", "身份核验失败、疑似冒名或异常开户", "SOP-AC-001", "行业通行Mock", "V1.0"],
    ["QA-AC-002", "账户服务", "账户分类", "一类户和二类户有什么区别？", "I类II类账户区别；二类户限制", "个人客户", "一类户通常作为全功能结算账户；二类户功能和交易限额受监管及本行渠道规则限制。具体限额应以办理当日系统提示为准，客户经理不得口头承诺固定限额。", "账户状态正常", "无", "网点或支持的电子渠道", "限额会随监管和风控策略调整", "客户要求突破限额", "SOP-AC-001", "公开规则概括+Mock口径", "V1.0"],
    ["QA-AC-003", "账户服务", "手机号变更", "客户换手机号后怎么修改预留手机号？", "改手机；预留号码变更", "个人客户", "原则上由客户本人持有效身份证件和银行卡到网点办理；若电子渠道支持且客户通过增强认证，可按页面流程办理。涉及高风险账户时仅限柜面核验。", "账户可正常验证", "身份证件、银行卡、新实名手机号", "网点；符合条件时电子渠道", "不得代客户接收验证码", "原手机号停用且认证失败、账户被管控", "SOP-AC-002", "行业通行Mock", "V1.0"],
    ["QA-DP-001", "存款业务", "大额存单", "大额存单可以提前支取吗？", "提前取大额存单；提前支取利息", "持有本行大额存单的个人客户", "是否允许提前支取、可支取次数及计息方式，以具体产品说明书和系统展示为准。办理前必须向客户说明提前支取可能造成利息损失。", "产品支持提前支取", "身份证件、账户介质", "网点或产品支持的电子渠道", "不得将历史产品规则套用于当前产品", "系统与产品说明书不一致", "SOP-DP-001", "产品规则Mock", "V1.0"],
    ["QA-DP-002", "存款业务", "定期存款", "定期存款到期会自动续存吗？", "自动转存；定期到期怎么办", "个人客户", "取决于开户时选择。约定自动转存的，通常按到期日对应期限的挂牌利率续存；未约定的，按产品协议处理。应查询原交易回单或系统约定，不凭经验回答。", "账户及存单状态正常", "无", "客户经理工作台查询后答复", "利率以到期日实际规则为准", "历史纸质存单无法查询", "SOP-DP-001", "行业通行Mock", "V1.0"],
    ["QA-LN-001", "个人贷款", "消费贷款", "申请个人消费贷通常需要哪些材料？", "消费贷材料；贷款申请资料", "有稳定收入的个人客户", "基础材料包括身份证明、婚姻及居住信息、收入或还款能力证明、贷款用途材料和征信授权；系统预审批不代表最终获批，具体以客户情况和产品要求为准。", "年龄、征信、收入等满足产品准入", "身份证明、收入证明、用途证明、征信授权", "客户经理受理后提交线上审批", "严禁包装用途或承诺审批结果", "用途不清、收入异常、征信异议", "SOP-LN-001", "行业通行Mock", "V1.0"],
    ["QA-LN-002", "个人贷款", "经营贷款", "个体工商户申请经营贷要准备什么？", "经营贷材料；个体户贷款", "持续经营的个体工商户", "除个人身份材料外，通常需营业执照、经营流水、经营场所或上下游证明、贷款用途材料及征信授权。不同担保方式还需补充抵押物或保证人资料。", "真实经营且经营期限满足产品规则", "营业执照、经营流水、用途证明、征信授权", "网点或线上预约后尽调", "不得将消费用途包装成经营用途", "经营真实性存疑或现金流水占比异常", "SOP-LN-002", "行业通行Mock", "V1.0"],
    ["QA-LN-003", "个人贷款", "住房按揭", "按揭贷款审批一般要多久？", "房贷多久批；按揭审批时效", "符合本行按揭准入的购房客户", "材料齐全后，华辰银行Mock服务目标为5个工作日内完成内部审批；抵押登记和放款时间还受交易、登记机关及额度安排影响，不得向客户承诺固定放款日。", "材料齐全且外部查询正常", "购房、收入、首付款及征信相关材料", "网点受理", "审批时效不等于放款时效", "交易临近交割或客户要求承诺日期", "SOP-LN-003", "MOCK", "V1.0"],
    ...
    ["QA-WM-003", "财富管理", "理财赎回", "理财赎回后资金什么时候到账？", "赎回到账；理财取出多久到账", "持有本行代销或发行理财产品的客户", "到账时间取决于产品开放规则、赎回确认日和清算安排，应以产品说明书及交易页面预计到账日为准。节假日可能顺延。", "产品处于可赎回状态", "无", "原购买渠道", "不得用其他产品到账经验代替本产品规则", "超过预计到账日仍未到账", "SOP-WM-002", "产品规则Mock", "V1.0"],
    ["QA-WM-004", "财富管理", "基金定投", "基金定投可以随时暂停吗？", "暂停定投；取消基金扣款", "已签约基金定投的客户", "通常可在约定扣款日前通过原签约渠道暂停或终止，具体截止时间以系统提示和基金销售规则为准。已进入扣款处理的当期计划可能无法撤销。", "签约状态正常", "无", "手机银行或网点", "暂停定投不等于赎回已持有份额", "当期已扣款但客户要求撤销", "SOP-WM-002", "产品规则Mock", "V1.0"],
    ["QA-IN-001", "保险代销", "双录", "哪些保险销售场景需要双录？", "保险双录；录音录像要求", "购买本行代销保险的客户", "应根据客户年龄、销售渠道、产品类型及现行监管和本行制度判断。系统提示需双录的，必须在规定场所和流程内完成，不得拆分交易或变更渠道规避。", "客户本人投保", "身份证明及投保资料", "网点双录专区或合规远程渠道", "双录未完成不得进入后续销售确认", "客户拒绝录制或设备故障", "SOP-IN-001", "监管概括+Mock流程", "V1.0"],
    ...
    ["QA-FR-001", "反欺诈", "账户管控", "客户账户突然不能转账怎么办？", "转账失败；账户被限制", "账户交易受限客户", "先核验客户身份并查询可对客展示的限制类型，再告知办理渠道和材料。不得透露内部风险模型、名单来源或具体监测规则。司法冻结等情形按有权机关协助规定处理。", "本人咨询", "身份证件；按限制原因补充", "网点或客服协同", "不得承诺立即解除", "涉及司法冻结、疑似诈骗或客户情绪激烈", "SOP-FR-001", "行业通行Mock", "V1.0"],
    ...
    ["QA-CS-002", "投诉服务", "处理时效", "投诉多久能有回复？", "投诉回复时间；几天处理", "已登记投诉的客户", "受理时应告知预计处理时间。华辰银行Mock服务目标为简单投诉3个工作日内反馈，复杂投诉15日内反馈阶段性进展；法定或监管时限优先适用。", "投诉已成功登记", "投诉编号", "原受理渠道", "复杂案件不得无故长期挂起", "超过承诺时间或客户要求监管投诉", "SOP-CS-001", "MOCK", "V1.0"],
    ...
    ["QA-MK-002", "营销合规", "外呼", "客户经理可以用个人微信发产品海报吗？", "微信营销；个人号发产品", "存量客户营销", "仅可使用本行批准的渠道和物料。未经审批的海报、个人加工的收益对比及含客户隐私的截图不得发送；是否允许使用工作微信以本行制度为准。", "客户已同意接收相应营销信息", "审批版营销材料", "本行批准渠道", "尊重退订和拒收选择", "物料来源不明或客户投诉骚扰", "SOP-MK-001", "营销合规Mock", "V1.0"],
    ...
    ["QA-PR-002", "隐私保护", "资料传输", "客户可以把身份证照片发给客户经理吗？", "微信发身份证；传客户资料", "需要提交业务材料的客户", "应优先引导客户通过本行批准的安全渠道上传。不得要求客户发送到个人邮箱或个人社交账号；已误收的，应按本行信息安全流程处置，不得自行留存或转发。", "确有业务材料收集需要", "按业务最小必要范围", "官方上传渠道或网点", "禁止在个人设备长期保存", "材料已泄露或发送给错误人员", "SOP-PR-001", "隐私保护Mock", "V1.0"],
    ["QA-OP-001", "服务运营", "上门服务", "行动不便的老人能申请上门服务吗？", "老人上门；特殊客户服务", "因高龄、疾病或残障确有困难的客户", "可登记特殊服务申请，由网点评估业务是否支持上门见证或其他便利安排。上门服务不等于放宽身份核验、真实意愿和授权要求。", "客户本人有真实业务需求", "身份证明、情况说明；按业务补充", "联系开户网点", "至少双人服务并完整留痕（Mock要求）", "疑似胁迫、认知能力存疑或代理争议", "SOP-OP-001", "行业通行Mock", "V1.0"],
]
...
def add_qa_sheet(wb):
    ws = wb.active
    ws.title = "客户经理QA"
    set_title(ws, "华辰银行零售客户经理常见问答库（Mock 小样）", 15,
    ...
    dv = DataValidation(type="list", formula1='"MOCK,行业通行Mock,公开规则概括+Mock口径,适当性通行要求,合同口径,KYC通行要求,反洗钱通行要求,销售合规通行要求,隐私保护通行要求"')
...
def add_matrix_sheet(wb):
    ...
    set_title(ws, "零售业务准入与材料矩阵（Mock）", 12,
    ...
    headers = ["项目", "产品类型", "适用客群", "年龄范围(Mock)", "经营/工作要求", "信用要求", "身份证明", "收入/流水材料", "用途材料", "担保材料", "标准处理时效(Mock)", "关键控制点"]
    ...
    ws.merge_cells("A10:L10"); ws["A10"] = "注：以上年龄、时效和产品条件全部为Mock演示值；实际办理以具体产品制度、监管政策及系统校验为准。"
...
def add_sop_sheet(wb):
    ...
    set_title(ws, "零售客户经理办理流程 SOP 矩阵（Mock）", 11,
    ...
    headers = ["项目", "流程阶段", "责任角色", "操作动作", "系统/渠道(Mock)", "标准时限(Mock)", "输入材料", "输出/留痕", "关键控制点", "异常分支", "客户沟通口径"]
...
def add_exception_sheet(wb):
    ...
    set_title(ws, "客户经理异常场景分级处置矩阵（Mock）", 12,
              "红色为必须立即升级的高风险情形；所有时效和内部岗位名称均为演示口径。")
    for rng, value in [("A3:C3", "场景识别"), ("D3:F3", "风险判断"), ("G3:I3", "处置动作"), ("J3:L3", "沟通与留痕")]:
        ws.merge_cells(rng); ws[rng.split(":")[0]] = value
    style_header(ws, 3, 1, 12, NAVY)
    headers = ["项目", "业务领域", "异常场景", "风险等级", "识别信号", "禁止动作", "首要动作", "升级对象", "处置时限(Mock)", "客户沟通要点", "留痕材料", "关联SOP编号"]
...
def add_readme_sheet(wb):
    ...
    sections = [
        (4, "一、数据边界", "“华辰银行”为虚构机构。除行业通行原则外，客户等级、年龄、办理时效、系统名称及审批岗位均为Mock，不应用于真实客户服务。"),
